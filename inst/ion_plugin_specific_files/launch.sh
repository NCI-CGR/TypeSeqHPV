...
set -x
# TypeSeq HPV Plugin
VERSION="1.18.08.0902"
#autorundisable
echo Pipeline version $VERSION

ln ../../*.bam ./

docker run -i -v $(pwd):/mnt cgrlab/typeseqhpv:final_2018080901 Rscript /TypeSeqHPV/workflows/ion_workflow.R \
...
mv Ion_Torrent_report.pdf ./TypeSeqHPV_QC_report.pdf
