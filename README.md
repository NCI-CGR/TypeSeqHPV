...
We recommend running the pipeline inside the docker container ```cgrlab/typeseqhpv:final_190104``` as it contains all the required dependencies in the correct locations.
